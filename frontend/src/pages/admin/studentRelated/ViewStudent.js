...
const ViewStudent = () => {
    ...
    useEffect(() => {
        if (userDetails) {
            ...
            setGpa(calculateGpa(userDetails.examResult));
        }
    }, [userDetails]);
        ...
        return (
            <div>
                ...
                <Typography variant="subtitle1" component="p">
                  Department: {userDetails?.department ?? 'Not Set'}
                </Typography>
                {/* Semester */}
                <Typography variant="subtitle1" component="p">
                  Semester: {userDetails?.semester ?? 'Not Set'}
                  <Typography variant="subtitle1" component="p">GPA: {gpa !== null ? gpa : 'Not Available'}</Typography>
                </Typography>
                {
                    subjectAttendance && Array.isArray(subjectAttendance) && subjectAttendance.length > 0 && (
