  ...
  const SubjectDetailsSection = () => {
    ...
    return (
      <>
        ...
        <Typography variant="h6" gutterBottom>
          Credits : {subjectDetails && subjectDetails.credits != null ? subjectDetails.credits : 'Not Set'}
        </Typography>
        <Typography variant="h6" gutterBottom>
          Schedule : {`${subjectDetails?.day || 'Not Set'} | ${subjectDetails?.startTime || 'Not Set'} - ${subjectDetails?.endTime || 'Not Set'} | ${subjectDetails?.room || 'Not Set'}`}
        </Typography>
        <Typography variant="h6" gutterBottom>
